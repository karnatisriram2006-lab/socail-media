...
function AnimatedStat({ stat, isVisible, index }) {
  ...
  return (
    ...
    >
      <div className="w-14 h-14 mx-auto mb-6 rounded-2xl bg-blue-600/10 flex items-center justify-center group-hover:scale-110 group-hover:bg-blue-600/20 transition-all duration-300">
...
export default function StatsSection() {
  ...
  return (
    <section ref={ref} className="py-32 relative overflow-hidden bg-gradient-to-b from-gray-900 to-gray-950">
