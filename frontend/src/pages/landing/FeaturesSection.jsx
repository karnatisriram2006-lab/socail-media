  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
        <div className="w-16 h-16 rounded-2xl bg-warm-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
        ...
        <motion.div className="h-1 w-0 bg-gradient-to-r from-warm-500 to-warm-300 rounded-full group-hover:w-full transition-all duration-500 mt-auto" />
      </div>
    </motion.div>
  );
}
